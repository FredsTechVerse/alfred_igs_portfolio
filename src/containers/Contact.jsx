...
import PhotographEssay from "../assets/PhotographEssay.pdf";
import CVAllLanguages from "../assets/CVAllLanguages.pdf";
import AutoBiography from "../assets/AutoBiography.pdf";
import AfricanCultureAspect from "../assets/AfricanCultureAspect.pdf";
    ...
    <article id="contact" className="w-full bg-slate-100 rounded-t-lg">
       <section className="section_hidden w-full px-10 py-16">
        <SectionHeading subTitle="Know more" title="Resources" />
         ...
         <section className="grid-lg mt-10">
           <a
            href={CVAllLanguages}
          ...
          >
            ...
            href={AfricanCultureAspect}
            download="AfricanCultureAspect"
            className="bg-primary hover:bg-red-500 h-12 rounded-full px-4  text-white w-[80%] tablet:w-56 flex flex-row items-center justify-center mx-auto laptop:mx-0"
          >
            African Culture Aspect
          </a> <a
            href={AutoBiography}
